...
class FONTS:
    ...
    SITKASMALL = 'sitkasmall'
    SITKATEXT = 'sitkatext'
    SITKASUBHEADING = 'sitkasubheading'
    SITKAHEADING = 'sitkaheading'
    SITKADISPLAY = 'sitkadisplay'
    SITKABANNER = 'sitkabanner'
    SYLFAEN = 'sylfaen'
    SYMBOL = 'symbol'
    TAHOMA = 'tahoma'
    ...
    DEJAVUSANSMONOOBLIQUE = 'dejavusansmonooblique'
    ENIGMATIC = 'enigmatic'
    EUROPEEXT = 'europeext'
    KEHOSYMBOL = 'kehosymbol'
    PARTNERCONDENSED = 'partnercondensed'
    WARHELIOSCONDCBOLD = 'warhelioscondcbold'
    MICRC = 'micrc'
    MICRACB = 'micracb'
    MICRANORMAL = 'micranormal'
    NDO = 'ndo'
    CUPRUM = 'cuprum'
    DAMAGELOG = 'damagelog'
    LATHA = 'latha'
    VISITORTT1BRK = 'visitortt1brk'
